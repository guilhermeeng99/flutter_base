...
class TranslationsPt with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsChallengesPt challenges = _TranslationsChallengesPt._(_root);
...
// Path: challenges
class _TranslationsChallengesPt implements TranslationsChallengesEn {
	_TranslationsChallengesPt._(this._root);

	final TranslationsPt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Desafios';
	@override String get subtitle => 'Veja exemplos de código e pratique!';
	@override String get empty => 'Nenhum desafio ainda';
	@override String get notFound => 'Desafio não encontrado';
	@override String get copyCode => 'Copiar código';
	@override String get codeCopied => 'Código copiado!';
	@override String get beginner => 'Iniciante';
	@override String get intermediate => 'Intermediário';
	@override String get advanced => 'Avançado';
	@override String get forumTitle => 'Desafios Explicados';
	@override String get forumSubtitle => 'Veja exemplos de código e pratique!';
}
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'challenges.subtitle' => 'Veja exemplos de código e pratique!',
			'challenges.empty' => 'Nenhum desafio ainda',
			'challenges.notFound' => 'Desafio não encontrado',
			'challenges.copyCode' => 'Copiar código',
			'challenges.codeCopied' => 'Código copiado!',
			'challenges.beginner' => 'Iniciante',
			'challenges.intermediate' => 'Intermediário',
			'challenges.advanced' => 'Avançado',
			'challenges.forumTitle' => 'Desafios Explicados',
			'challenges.forumSubtitle' => 'Veja exemplos de código e pratique!',
